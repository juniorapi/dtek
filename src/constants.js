...
// Кожна група має свій окремий файл артефактів
export const LAST_MESSAGE_FILE = path.resolve(
  "artifacts",
  `last-message-${process.env.GROUP?.replace(".", "-")}.json`
)

export const RETRIES_MAX_COUNT = 5
export const RETRIES_TIMEOUT = 5000

export const HOURLY_INTERVAL = 60 * 60 * 1000
